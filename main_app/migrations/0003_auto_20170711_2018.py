# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-11 20:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main_app', '0002_auto_20170706_2037'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='listing',
            name='budget',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10, verbose_name='Budget'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='date',
            field=models.DateField(blank=True, default=datetime.datetime.now, verbose_name='Date Posted'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='description',
        ...
        migrations.AlterField(
            model_name='listing',
            name='requirement1',
            field=models.CharField(max_length=50, verbose_name='Requirements(1)'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='requirement2',
            field=models.CharField(max_length=50, verbose_name='Requirements(2)'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='requirement3',
            field=models.CharField(max_length=50, verbose_name='Requirements(3)'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='topic',
